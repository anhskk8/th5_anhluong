...
namespace TH4_TranTienDat_1824801030161
{
    class CreateValid
    {
        ...
        public void TCCreate05(string email, string firstname, string lastname, string pass, string address, string city, string state, string postcode, string country, string phone, string expected)
        {
